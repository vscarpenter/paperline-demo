...
| File | Description |
|---|---|
| `index.html` | Marketing landing page — hero, features, testimonials, pricing |
| `dashboard.html` | Main app dashboard — stat cards, documents table, activity feed |
| `analytics.html` | Analytics view — charts, space breakdown, top documents, engagement metrics |
| `team.html` | Team management — member list, role permissions, invite form, remove modal |
